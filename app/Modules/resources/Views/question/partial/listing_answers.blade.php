...
@else
    ...
    <div class='mb18 mr10 mt20 pos_rel'>
        ...
        <div class='col-md-10'>
        <p style='w93 fltL'>
            <textarea name='answer_textarea[]' id='answer_textarea_{{ uniqid() }}' class='required' data-type='tinymce' data-name='Answer Text' data-read_only='false'>{!! htmlspecialchars($answer) !!}</textarea>
            <div class='clr'></div>
        </p>
        </div>
        <div class='clr'></div>
