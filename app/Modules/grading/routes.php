...
Route::group(array('module'=>'grading', 'prefix' => 'grading', 'middleware' => 'auth', 'namespace' => 'App\Modules\Grading\Controllers'), function() {
    ...
    Route::post('list-student-ajax/{id}/{assessment_id}', ['as' => 'studentGradingAjax', 'uses' => 'GradingController@studentGradeListingAjax']);
...
//    Route::get('student-inner-grade/{id}', ['as' => 'studentGradingInner', 'uses' => 'GradingController@studentGradingInner']);
    ...
    Route::post('list-student-question/fib_grading_submit/{assessment_id}/{assignment_id}/{user_id}',["uses"=>"GradingController@submit_fib_score"]);
    ...
    Route::get('gradesBulkImport',['as'=>'gradesBulkImport','uses'=>'GradingController@gradesBulkImport']);
      Route::get('bulkGradeTemplate',['as'=>'bulkGradeTemplate','uses'=>'GradingController@bulkGradeTemplate']);
        Route::post('bulkGradeUpload',['as'=>'bulkGradeUpload','uses'=>'GradingController@bulkGradeUpload']);
});
